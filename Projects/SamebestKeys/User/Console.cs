...
{
    public class Console : Regulus.Utility.Framework<Regulus.Project.SamebestKeys.IUser>
    {
        ...
        protected override Regulus.Utility.Framework<Regulus.Project.SamebestKeys.IUser>.ControllerProvider[] _ControllerProvider()
        {
