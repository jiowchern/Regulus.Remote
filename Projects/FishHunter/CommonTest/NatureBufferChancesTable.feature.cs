// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NatureBufferChancesTable.feature.cs" company="">
//   
// </copyright>
// <summary>
//   Defines the NatureBufferChancesTableFeature type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
	...
	public partial class NatureBufferChancesTableFeature
	{
		...
		public static void FeatureSetup(TestContext testContext)
		{
			...
			var featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), 
				"NatureBufferChancesTable", "In order to 計算自然buffer\r\nAs a math 自然buffer表\r\nI want to be 根據公式得到buffer區間(最小~最大)", 
...
#line hidden
		...
		{
			var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("取得自然buffer區間", new[]
			{
				"mytag"
			});
#line 23
...
#line 24
			NatureBufferChancesTableFeature.testRunner.When("基數是-3", (string)(null), (TechTalk.SpecFlow.Table)(null), "When ");
#line hidden
