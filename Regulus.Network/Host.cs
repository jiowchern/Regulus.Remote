...
namespace Regulus.Network
{
    public class Host : IUpdatable<Timestamp>
    {
        ...
        private void DestroyPeer(Line Line)
        {
            ...
            KeyValuePair<Line, Socket> peer = m_Peers.FirstOrDefault(P => P.Key == Line);
        ...
        {
            PeerListener listener = new PeerListener(Line);

            Socket peer = new Socket(Line, listener);
